...
counties yields **582 published** sales ≥ $1,000 (Marathon 224, Portage 118, Lincoln
70, Shawano 68, Taylor 54, Langlade 48), zero house numbers, no parcel IDs, every
municipality mapped. The frontend defaults to the whole region/month with county,
community, and week drill-down filters plus a median-price-by-county chart.
...
│       ├── components/       # Masthead, SummaryStats, Filters, PriceCharts,
│       │                     #   TransactionTable, MunicipalityMap (lazy)
│       ├── lib/              # format.js, wpr-logo.js, municipalities.js (generated)
